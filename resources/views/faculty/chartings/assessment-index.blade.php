...
<head>
  <meta charset="utf-8">
  <title>Patient Assessment · NurSync (CI)</title>
      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-slate-500 max-w-md">
            View documented assessment findings, plans, and notes for this patient’s clinical status.
          </p>
        </div>
            ...
            <details
              ...
              <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4">
                <div class="flex items-start gap-3">
                  <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-sky-50">
                    <i data-lucide="clipboard-check" class="h-4 w-4 text-sky-600"></i>
                  </span>
              ...
              <div class="px-5 pb-5 pt-3 border-t border-slate-100 text-sm text-slate-700 space-y-3 bg-slate-50/60">
                ...
                <div class="grid md:grid-cols-3 gap-3">
                  ...
                  <div class="md:col-span-3 rounded-lg bg-white px-3 py-2.5 border border-slate-200">
                    <span class="block text-xs font-semibold uppercase tracking-[0.16em] text-slate-500 mb-1">
                      Notes
                    </span>
                    <p class="text-sm text-slate-800 whitespace-pre-line">
                ...
                <div class="flex flex-wrap items-center justify-between gap-2 pt-1">
                  ...
                  @if($assessedBy)
                    <p class="text-xs text-slate-400">
                      Assessed by:
                      <span class="font-semibold text-slate-600">{{ $assessedBy }}</span>
                    </p>
                  @endif
                </div>
              </div>
