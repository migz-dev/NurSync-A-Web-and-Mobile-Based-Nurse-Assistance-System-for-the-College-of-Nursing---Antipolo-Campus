...
<head>
  <meta charset="utf-8">
  <title>Daily Progress · NurSync (CI)</title>
      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-slate-500 max-w-md">
            View daily summaries, plans, and remarks documenting the patient’s ongoing clinical course.
          </p>
        </div>
        ...
        <div class="space-y-3">
          @foreach($records as $row)
            @php
              ...
              $entryDate  = $dateObj->format('M d, Y');
            ...
            <details
              ...
              <summary class="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4">
                <div class="flex items-start gap-3">
                  <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100">
                    <i data-lucide="calendar-range" class="h-4 w-4 text-slate-700"></i>
                  </span>
