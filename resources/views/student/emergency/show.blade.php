{{-- resources/views/student/emergency/show.blade.php --}}
<!doctype html>
<html lang="en">
...
<head>
  ...
  <title>Emergency Protocol · NurSync (Student)</title>
    ...
    <div class="container mx-auto px-8 py-12 space-y-6">
      ...
      <header class="space-y-4">
        <div class="flex items-center justify-between gap-3">
          <button type="button"
                  onclick="window.location.href='{{ route('student.emergency.index') }}'"
          ...
          <div class="flex items-center gap-2 text-[11px] text-slate-500">
            ...
            <span>Study reference – follow school and hospital policies.</span>
          </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
          <div class="flex items-center justify-between mb-3">
            ...
            <span class="text-[11px] text-slate-500">
              Use with supervision during duty or simulation.
            </span>
          </div>
