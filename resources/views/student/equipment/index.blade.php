{{-- resources/views/student/equipment/index.blade.php --}}
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
  <title>Equipment Guides · NurSync</title>
  ...
  <style>
    ...
    /* Smooth card entrance after skeleton hides (same as CI Procedures/Equipment) */
...
<main class="min-h-screen flex">
  ...
  <section class="flex-1 min-w-0">
    <div class="container mx-auto px-8 py-12 space-y-6">
      ...
      {{-- Page heading (mirror CI Equipment / Procedures / Drug Guide style) --}}
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-[13px] text-slate-500 mt-1">
              Quick reference for nursing and laboratory equipment by category, ward, and related procedures — view-only for Student Nurses.
            </p>
          </div>
        </div>

        {{-- No "New Equipment" button on Student side (view-only) --}}
        <div class="hidden sm:flex"></div>
      </header>

      @php
        // Safety defaults in case controller didn't pass them (dev environments)
      ...
      <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 space-y-3">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {{-- No New Equipment on mobile either --}}
      ...
      {{-- Results grid (cards + skeleton, same grid pattern as CI Equipment) --}}
      ...
      {{-- Pager (same look as Drug Guide / Procedures / CI Equipment pager) --}}
...
<script>
  ...
  // --- Fetch helper ---
  const DATA_URL = @json(route('student.equipment.data'));
  ...
  // --- Card template (styled like CI Equipment / Procedures / Drug cards) ---
  ...
  // --- Skeleton cards (same as CI Equipment) ---
  ...
  // --- Animate cards after skeleton (same as CI) ---
