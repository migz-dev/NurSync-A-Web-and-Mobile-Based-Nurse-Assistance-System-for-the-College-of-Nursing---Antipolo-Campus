  ...
  <section class="flex items-center">
    ...
    >
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-slate-500">Let’s get you back to training</p>
      </div>
      ...
      <div class="mt-6">
        ...
        <div class="mt-3 flex items-center justify-center gap-4">
          ...
          <a href="{{ url('/admin/login') }}"
            ...
            <span class="text-sm font-medium text-slate-700 group-hover:text-slate-900">Administrator</span>
          </a>
          ...
          <a href="{{ url('/faculty/login') }}"
            ...
            <span class="text-sm font-medium text-slate-700 group-hover:text-slate-900">Clinical Instructor</span>
          </a>
...
<script>
  (function () {
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', playAuthAnimations);
    } else {
      playAuthAnimations();
    }

    // Also handle back/forward cache (some browsers)
